...
print("User Input Widget:",end-start)
...
print("User Update Input:",end-start)
#Participant List
start=perf_counter()
...
def get_plot(gene_set,covariate,positive,negative,participant): # start function
    ...
    meta=covariates[covariate_selection.value]
